...
day1st = fix( strmid( bandname(dayidx1),7,3))

day1ed = fix( strmid( bandname(dayidx1),11,3))
 
day1 =0.5*(day1st+day1ed)
 
 
day2st= fix( strmid( bandname(dayidx2),7,3))

day2ed= fix( strmid( bandname(dayidx2),11,3))
...
dayst1 = fix( strmid( bandname(dayidx1),7,3) )

dayed1 = fix( strmid( bandname(dayidx1),11,3) )
