...
pro time_series_process_nps_oneyear,tmp,bnames,threshold,snowcld,mid_interp,mid_smooth,mid_bname,vmetrics
...
interpol_noextension_1y_vector,tmp,tmp_bn,threshold,snowcld,tmp_interp,tmp_bq,tmp_bn,ratio,stnum_real,ednum_real,flg_metrics
